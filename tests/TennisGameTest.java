...
// "player2 wins"
	...
	@Test
	public void testTennisGame_WithDifferentScores() throws TennisGameException {
		TennisGame game = new TennisGame();
		game.player1Scored();
		String score = game.getScore();
	...
	// Additional tests for killing mutants in mutation testing
	...
	@Test
	public void testTennisGame_Player1WinsWith2PointsDifference() throws TennisGameException {
		TennisGame game = new TennisGame();
		game.player2Scored();
		game.player2Scored();
		game.player1Scored();
	...
	@Test
	public void testTennisGame_Player2WinsWith2PointsDifference() throws TennisGameException {
		TennisGame game = new TennisGame();
		game.player1Scored();
		game.player1Scored();
		game.player2Scored();
